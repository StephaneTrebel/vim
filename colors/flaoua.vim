...
hi Identifier term=underline cterm=bold ctermfg=5 guifg=DarkCyan
hi Function term=underline cterm=bold ctermfg=2 guifg=DarkCyan
hi String term=underline ctermfg=3 guifg=DarkCyan
hi Statement term=bold ctermfg=3 gui=bold guifg=Brown
hi Exception term=bold ctermfg=3 gui=bold guifg=Brown
